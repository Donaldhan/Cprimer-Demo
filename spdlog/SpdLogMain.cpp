...
/*
 * https://www.qnrtc.com/posts/1178514105.html
 *
 * @ClassName: SpdLogMain
 * @Description:    
 * @Author:  Ravitn
 * @Date: 2021-03-02 20:05
*/
#include "spdlog.h"
int main(){
    ...
    auto log = spdlog::create("SpdLogMain", sink_list);

    log->info("Test spdlog output:string:{}, int:{}", "spdlog info test string", 123456);
    log->flush();
}
